                     ...
                     mImageProvider.save(PostActivity.this, imageFile2).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> taskImage2) {
                           if (taskImage2.isSuccessful()) {
                                    ...
                                    mPostProvider.save(post).addOnCompleteListener(new OnCompleteListener<Void>() {
                                       ...
                                       public void onComplete(@NonNull Task<Void> taskSave) {
                                          ...
                                          if (taskSave.isSuccessful()) {
                                             clearForm();
                                             Toast.makeText(PostActivity.this, "La informacion se almaceno " +
                                                "correctamente", Toast.LENGTH_SHORT).show();
                                          } else {
                                             Toast.makeText(PostActivity.this, "No se pudo almacenar la informacion",
                              ...
                              mDialog.dismiss();
                              Toast.makeText(PostActivity.this, "La imagen numero 2 no se pudo guardar",
                                 Toast.LENGTH_SHORT).show();
                           }
                        }
                     });
